...
export const QualifiedValueNodeSchema = new Map<string, QualifiedValueInfo>([
	...
	['draft', QualifiedValueInfo.enum(new ValueSet(true, 'true', 'false'), undefined, l10n.t('Draft pull requests'))],
	['in', QualifiedValueInfo.enum(new ValueSet(true, 'title', 'body', 'comments'), undefined, l10n.t('Search in the title, body, comments, or any combination of these'))],
	...
	['state', QualifiedValueInfo.enum(new ValueSet(true, 'open', 'closed'), undefined, l10n.t('Issues and pull requests based on whether they are open or closed'))],
	['status', QualifiedValueInfo.enum(new ValueSet(true, 'pending', 'success', 'failure'), undefined, l10n.t('Pull requests based on the status of the commits'))],
	['type', QualifiedValueInfo.enum(new ValueSet(true, 'pr', 'issue'), undefined, l10n.t('Only issues or only pull requests'))],
	...
	['label', QualifiedValueInfo.placeholder(ValuePlaceholderType.Label, RepeatInfo.Repeat, true, l10n.t('Issues and pull requests with a certain label'))],
	['language', QualifiedValueInfo.placeholder(ValuePlaceholderType.Language)],
	['milestone', QualifiedValueInfo.placeholder(ValuePlaceholderType.Milestone, undefined, false, l10n.t('Issues and pull requests for a certain miletsone'))],
	['org', QualifiedValueInfo.placeholder(ValuePlaceholderType.Orgname, RepeatInfo.Repeat, false, l10n.t('Issues and pull requests in all repositories owned by a certain organization'))],
	['project', QualifiedValueInfo.placeholder(ValuePlaceholderType.ProjectBoard)],
	['repo', QualifiedValueInfo.placeholder(ValuePlaceholderType.Repository, RepeatInfo.Repeat, false, l10n.t('Issues and pull requests in a certain repository'))],
	['user', QualifiedValueInfo.username(RepeatInfo.Repeat, l10n.t('Issues and pull requests in all repositories owned by a certain user'))],
	...
	['assignee', QualifiedValueInfo.username(RepeatInfo.RepeatNegated, l10n.t('Issues and pull requests that are assigned to a certain user'))],
	['author', QualifiedValueInfo.username(RepeatInfo.RepeatNegated, l10n.t('Issues and pull requests created by a certain user'))],
	['commenter', QualifiedValueInfo.username(RepeatInfo.Repeat, l10n.t('Issues and pull requests that contain a comment from a certain user'))],
	['mentions', QualifiedValueInfo.username(RepeatInfo.Repeat, l10n.t('Issues and pull requests that mention a certain user'))],
	['involves', QualifiedValueInfo.username(RepeatInfo.Repeat, l10n.t('Issues and pull requests that in some way involve a user. The involves qualifier is a logical OR between the author, assignee, mentions, and commenter qualifiers for a single user'))],
	['review-requested', QualifiedValueInfo.username(undefined, l10n.t('Pull requests where a specific user is requested for review'))],
	['reviewed-by', QualifiedValueInfo.username(undefined, l10n.t('Pull requests reviewed by a particular user'))],
	// simple value
	['closed', QualifiedValueInfo.simple(ValueType.Date, l10n.t('Issues and pull requests based on when they were closed'))],
	['created', QualifiedValueInfo.simple(ValueType.Date, l10n.t('Issues and pull requests based on when they were created'))],
	['merged', QualifiedValueInfo.simple(ValueType.Date, l10n.t('Issues and pull requests based on when they were merged'))],
	['pushed', QualifiedValueInfo.simple(ValueType.Date, l10n.t('Issues and pull requests based on when they were pushed'))],
	['updated', QualifiedValueInfo.simple(ValueType.Date, l10n.t('Issues and pull requests based on when they were updated'))],
	['comments', QualifiedValueInfo.simple(ValueType.Number, l10n.t('Issues and pull request by number of comments'))],
	['interactions', QualifiedValueInfo.simple(ValueType.Number, l10n.t('Issues and pull request by number of interactions'))],
	['reactions', QualifiedValueInfo.simple(ValueType.Number, l10n.t('Issues and pull request by number of reactions'))],
